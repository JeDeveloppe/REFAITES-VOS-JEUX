<?php
@session_start ();
$_SESSION['alertMessage'] = "Page supprimée dans la version 2...";
$_SESSION['alertMessageConfig'] = "warning";
//ancienne url on redirige vers la page d'accueil
...
<div class="container-fluid">
    <h1 class="col-12 text-center mt-5">Expédition et retrait (version 1)</h1>
    <div class="row py-2">
