...
$contentMailToDestinataire = $headerCommun.$contentDemandeDevis.$footerReply;
...
$mail->addAddress($emailMembre);                              // ->destinataire
...
$mail->Subject = "Confirmation de votre demande de devis à REFAITES VOS JEUX";                     //objet du mail
...
if(!$mail->send()) {
    ...
    //ON SUPPRIME LA CLE DU PANIER
    unset($_SESSION['panierKey']);
    
    $_SESSION['alertMessage'] = "Demande de devis envoyée MERCI !";
    $_SESSION['alertMessageConfig'] = "success";
    header("Location: /panier/confirmation-demande/");
    exit();  
} 
?>