...
$contentMailToDestinataire = $headerCommun.$contentDevis.$footerNoReply;
...
$mail->Subject = "Suite à votre demande de devis...";     //objet du mail      
...
if(!$mail->send()) {
    ...
    $sqlDELETEDemande = $bdd->prepare("DELETE FROM listeMessages WHERE idUser = ? AND panierKey = ?");
    $sqlDELETEDemande->execute(array($donneesClient['idUser'],$panier));

    $_SESSION['alertMessage'] = "Message envoyé et demande supprimée!";
