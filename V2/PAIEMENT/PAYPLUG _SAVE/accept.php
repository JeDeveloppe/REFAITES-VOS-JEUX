...
if(!isset($_GET['doc']) || !isset($_GET['user'])){
    ...
    if($count != 1){
        ...
        $sqlClient = $bdd -> prepare("SELECT email,clients_facturation.nom,clients_facturation.prenom FROM clients_facturation JOIN clients ON clients.idUser = clients_facturation.idUser WHERE idClient = ?");
