        ...
        <div class="row d-flex justify-content-around p-2">
            ...
            <div class="col-12 mt-4">
                ...
                <div class="card p-0">
                    <div class="card-header bg-dark text-white">LES COMMANDES A ENVOYER...</div>
                        ...
                        <div class="col-12 h5 text-center p-2"><?php echo $countCommandesAenvoyer;?> résultat(s)</div>
                                ...
                                <?php
                                    while($donneesCommandesAenvoyer){
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle"><?php echo $donneesClient['nomLivraison'].' '.$donneesClient['prenomLivraison'].'<br/>'.$donneesClient['adresseLivraison'].'<br/>'.$donneesClient['cpLivraison'].' '.$donneesClient['villeLivraison'].'<br />'.$donneesClient['email'].' - '.$donneesClient['paysLivraison'] ;?></td>
                                            <td class="text-center align-middle"><?php if($donneesClient['paysFacturation'] == "FR"){echo "&#127467;&#127479;";}else{ echo "&#127463;&#127466;";}?></td>
                                            <td class="text-center align-middle"><?php echo $donneesCommandesAenvoyer['expedition'];?></td>
                                            <td class="text-center align-middle">
                                                <div class="btn-group" role="group">
                                                    <a href="/admin/commande/visualisation-facture-avant-envoi/<?php echo $donneesCommandesAenvoyer['idDocument'];?>/" class="btn btn-info">Voir</a>
                                                    <?php if($donneesCommandesAenvoyer['expedition'] == "colissimo"){
                                                        ...
                                                        echo '<a href="/administration/commande/ctrl/ctrl-envoi-commande-mail-envoi.php?doc='.$donneesCommandesAenvoyer['idDocument'].'" class="btn btn-success">Ok envoyé!</a>';
                                                    }
                                                    ?>
                                                    <a href="/administration/commande/ctrl/ctrl-mise-en-attente.php?newValue=3&doc=<?php echo $donneesCommandesAenvoyer['idDocument'];?>" class="btn btn-warning">Mettre en attente !</a><br/>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php
            ...
            <div class="col-12 mt-4">
                ...
                <div class="card p-0">
                    <div class="card-header bg-dark text-white">LES COMMANDES AVEC RETRAIT...</div>
                        <div class="card-body table-responsive">
                        <div class="col-12 h5 text-center p-2"><?php echo $countCommandesApreparer;?> résultat(s)</div>
                            <table class="table table-sm table-striped mt-4">
                                <thead class="thead-dark text-center">
                                    <tr>
                                        <th scope="col">N° Devis</th>
                                ...
                                <?php
                                    while($donneesCommandesApreparer){
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle"><?php echo $donneesClient['nomFacturation'].' '.$donneesClient['prenomFacturation'].'<br/>'.$donneesClient['adresseFacturation'].'<br/>'.$donneesClient['cpFacturation'].' '.$donneesClient['villeFacturation'].'<br />'.$donneesClient['email'];?></td>
                                            <td class="text-center align-middle"><?php echo $donneesCommandesApreparer['expedition'];?></td>
                                            <td class="text-center align-middle">
                                                <div class="btn-group" role="group">
                                                    <a href="/admin/commande/visualisation-facture-avant-envoi/<?php echo $donneesCommandesApreparer['idDocument'];?>/" class="btn btn-info">Voir</a>
                                                    <a href="/administration/commande/ctrl/ctrl-envoi-commande-mail-retrait.php?doc=<?php echo $donneesCommandesApreparer['idDocument'];?>" class="btn btn-success">Ok déposé!</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php
