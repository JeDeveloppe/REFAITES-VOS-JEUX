...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sqlInfosJeu = $bdd -> prepare("UPDATE catalogue SET v3 = :v3, deee = :deee, nom= :nom, editeur = :editeur, annee = :annee, urlNom = :urlNom, isLivrable = :livrable, isComplet = :complet, poidBoite = :poid, age = :Age, nbrJoueurs = :Joueurs, prix_HT = :prixHT WHERE idCatalogue = :jeu");
    $sqlInfosJeu-> execute(array("v3" => $v3, "deee" => $deee, "nom" => $nom,"editeur" => $editeur,"annee" => $annee, "urlNom" => $urlNom, "jeu" => $jeu, "livrable" => $jeuCompletLivraison, "complet" => $jeuComplet, "poid" => $poidBoite, "Age" => $age, "Joueurs" => $joueurs, "prixHT" => $prixHT));
