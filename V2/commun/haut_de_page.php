          ...
          <div class="col-12 d-flex justify-content-end">
            <ul class="navbar-nav font-weight-bold">
              ...
              <li class="nav-item mx-md-1 mt-1 mt-md-0" data-html="true" data-toggle="tooltip" data-placement="bottom" title="Panier">
                <a class="nav-link text-primary position-relative <?php echo $textPanier; ?>" href="<?php echo $lienUrlPanier; ?>"><i class="fas fa-shopping-bag text-refaites<?php if ($nbreDeMessage > 0) {
                                                                                                                                                                                echo 'fa-box-open-scale';
                                                                                                                                                                              } ?>"></i><b class="text-right"><?php echo $textPanier; ?></b></a>
              </li>
            </ul>
          </div>
        </div>
