...
}else if(preg_match('#connexion-inscription#',$_SERVER['REQUEST_URI'])){
    $pageStatGoogleCapcha = "connexionInscription";  
}else if(preg_match('#/achats/#',$_SERVER['REQUEST_URI'])){
    $pageStatGoogleCapcha = "achats";  
}
?>
