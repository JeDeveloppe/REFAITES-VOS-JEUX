                ...
                while($donneesSitemapRecherche){
                    ...
                    echo '<tr>
                        ...
                        <td class="text-center">
                            <a href="/administration/sitemaps/ctrl/ctrl-delete.php?id='.$donneesSitemapRecherche['idSitemaps'].'&rangee='.$rangee.'" class="btn btn-danger">Supprimer</a>';

                            if($donneesSitemapRecherche['idJeu'] != 0){
                                echo '<a href="/admin/jeu/'.$donneesSitemapRecherche['idJeu'].'/edition/" target="_blank" class="btn btn-info ml-2">Voir</a>';
                            }else{
                                echo '<a href="'.$donneesSitemapRecherche['url'].'" target="_blank" class="btn btn-info ml-2">Voir</a>';
                            }
                            echo '
                        </td>
                        </tr>';
