...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $media = valid_donnees($_POST['idDuMedia']);
    ...
    $sqlInfosJeu = $bdd -> prepare("UPDATE medias SET date = ?, titre = ?, content = ?, image = ?, lien = ?, actif = ? WHERE idMedia = ?");
    $sqlInfosJeu-> execute(array($timestampPublication,$nom,$content,$imgBase64,$url,1,$media));

    $_SESSION['alertMessage'] = "Média mis à jour !";
