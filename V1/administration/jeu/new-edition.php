    ...
    <div class="row">
        <div class="card mt-3 p-0 col-11 mx-auto">
            <div class="card-header bg-dark text-white d-flex justify-content-around">
                <div class="col align-self-center">Création jeu en bdd...</div>
                <div class="col text-right"><button class="btn btn-danger ml-1">HORS LIGNE</div>
            </div>
            <div class="card-body">
                <form class="col-12 mt-5 d-flex flex-wrap justify-content-around" method="post" action="/administration/jeu/ctrl/ctrl-new-edition.php" enctype="multipart/form-data">
                    ...
                    <div class="col-12 d-flex flex-wrap">
                        ...
                        <div class="form-group text-center col-4">
                            ...
                            <input type="text" name="poidBoite" placeholder="En gramme"> G
                        </div>
