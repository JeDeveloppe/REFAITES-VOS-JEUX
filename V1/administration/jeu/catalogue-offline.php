...
$titreDeLaPage = "[ADMIN] - Catalogue des jeux hors ligne";
$descriptionPage = "";
...
$sqlJeux = $bdd -> query("SELECT * FROM catalogue $requeteRecherche AND actif = 0 ORDER BY nom ASC");
...
<div class="container-fluid">
    <div class="col h1 text-center mt-4 text-danger">Catalogue des jeux hors ligne</div>
    ...
    <div class="col mt-4">
        ...
        <a href="/admin/jeu/catalogue/offline/" class="btn btn-outline-danger ml-2">Éffacer la recherche</a>
      </form>
    </div>
