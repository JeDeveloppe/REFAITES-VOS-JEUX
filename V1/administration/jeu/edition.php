        ...
        if(empty($_GET['jeu']) || !preg_match('#^[0-9]{1,25}$#', $jeu)){
            ...
            if($count< 1){
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <?php
                        //retour catalogue offline ou online
                        if(isset($_GET['tri'])){
                            $tri = "?tri=".$_GET['tri'];
                        }else{
                            $tri = "";
                        }
                        if(isset($_GET['etat']) && isset($_GET['tri'])){
                            echo '<div class="col mt-4 text-center"><a href="/admin/jeu/catalogue/general/'.$tri.'/#'.$jeu.'" class="btn btn-warning borber border-primary">Retour au catalogue <br/>général</a></div>';
                        }else{
                            echo '<div class="col mt-4 text-center"><a href="/catalogue/#'.$jeu.'" class="btn btn-warning borber border-primary">Retour au catalogue</a></div>';
                        }
                        ?>
                    </div>
                    <!-- JEU DU CATALOGUE  -->
                            ...
                            <div class="card-body p-1">
                                <form class="col-12 d-flex flex-wrap justify-content-around" method="post" action="/administration/jeu/ctrl/ctrl-edition.php" enctype="multipart/form-data">
                                    ...
                                    <div class="jumbotron bg-vos col-6 mt-2 p-2">
                                        ...
                                        echo '<textarea name="pieces" cols="40" rows="5" class="p-4" placeholder="(vide)">'.$donneesContenuJeu['contenu_total'].'</textarea>';
                                        ?>
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex flex-wrap justify-content-start">
                                        ...
                                        <div class="form-group text-center col-4">
                                            ...
                                            <input class="text-center" type="text" name="prixHT" placeholder="10.00" pattern="([0-9]{1,2}).([0-9]{2})" value="<?php echo number_format($donneesJeu['prix_HT']/100,2,",","");?>">
                                        </div>
                                        <div class="form-group text-center col-4">
