...
$sqlRequete = $bdd -> query("SELECT idJeu, COUNT(*) FROM documents_lignes GROUP BY idJeu ORDER BY count(*) DESC LIMIT 10");
...
include_once("../../commun/alertMessage.php");
    ?>
    <div class="container">
        <div class="col-12 text-center mt-5 mb-3"><h3>Les 10 jeux ayant le plus de demandes.</h3></div>
                ...
                while($donneesRequete){
                    ...
                    <div class="col-5 p-0 mx-auto border border-secondary d-flex my-2" id="<?php echo $donneesCatalogue['idCatalogue']; ?>">
                        ...
                        <div class="col-6 p-0 bg-white">
                            ...
                            <div class="col-12 text-center mt-2">Nbre de demandes: <?php echo $countVendu; ?></div>
