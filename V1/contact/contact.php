...
<div class="container-fluid pt-4">
    <div class="card col-11 col-sm-10 col-md-8 col-lg-6 p-0 mx-auto mt-5">
        <div class="card-header bg-dark text-white text-center"><h1>Contacter le service</h1></div>
        <div class="card-body">
        ...
        <p class="col text-center my-3">
        <i class="fas fa-exclamation-triangle text-danger"></i> Le jeu que vous cherchez n’est pas en stock ?<br />
        <a href="/bouteille-a-la-mer/" class="text-info">Vous pouvez lancer une bouteille à la mer !</a>
        </p>
