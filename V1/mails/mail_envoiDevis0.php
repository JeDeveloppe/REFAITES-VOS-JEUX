...
if(!$mail->send()) {
    ...
    $sqlDELETEDemande = $bdd-> prepare("DELETE FROM listeMessages WHERE idUser = ?");
    $sqlDELETEDemande-> execute(array($donneesClient['idUser']));

    $_SESSION['alertMessage'] = "Message envoyé !";
