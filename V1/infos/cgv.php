...
<div class="container-fluid">
    ...
    <div class="col text-center small">Date de dernière mise à jour : 07/01/2021</div>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 1 - Objet</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 2 - Prix</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 3 - Commandes</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 4 - Validation de votre commande</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 5 - Paiement</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 6 - Rétractation</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 7 - Livraison</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 8 - Responsabilité</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 9 - Droit applicable en cas de litiges</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 10 - Propriété intellectuelle</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 11 - Données personnelles</h2>
    ...
    <div class="col mt-4">
        <h2 class="col text-center mb-3">Article 12 - Archivage Preuve</h2>
